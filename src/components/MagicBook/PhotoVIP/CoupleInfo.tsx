// src/components/MagicBook/PhotoVIP/CoupleInfo.tsx
...
const CoupleInfo: React.FC<CoupleInfoProps> = ({ onNext, onBack, goToTOC }) => {
  ...
  const handleNext = () => {
    const coupleInfo = {
      loveBird1: {
        first: loveBird1First,
        last: loveBird1Last,
        label: loveBird1Title,
      },
      loveBird2: {
        first: loveBird2First,
        last: loveBird2Last,
        label: loveBird2Title,
      },
    };
  ...
  const handleBackToTOC = () => {
    console.log(
      "[DBG][CoupleInfo] TOC click – has goToTOC?",
    ...
    >
      ...
      >
        ...
        >
          ...
          <p>
            To help us tailor your photo shot list, we’d love to know your names
            and the title you&apos;d like to use.
          </p>
          <p>
            Pick one from the dropdown{" "}
            <strong>(Bride, Groom, or Partner)</strong> and enter your first and
            last name.
          </p>
        </div>
