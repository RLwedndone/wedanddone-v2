...
const FloralAccountModal: React.FC<FloralAccountModalProps> = ({
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      console.error("[FloralAccountModal] login failed:", err);
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      console.error("[FloralAccountModal] reset failed:", err);
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      console.error("[FloralAccountModal] Google sign-in failed:", err);
  ...
  const showForm = step === "signup" || step === "login";
  ...
  className={`pixie-card ${
    step === "choice" ? "account-card--compact" : "account-card--expanded"
  }`}
          ...
          {step === "signup" && (
            <>
              ...
              >
                ...
                Wed&amp;Done is currently booking Arizona weddings only, but we&apos;ll be blooming in more places soon!
              </p>
              ...
              <div style={{ width: "100%", maxWidth: 440, margin: "0 auto 1.25rem" }}>
                <div style={{ display: "grid", gap: 12 }}>
                  <input
                    ...
                    value={firstName}
                    onChange={(e) => { setFirstName(e.target.value); clearNotices(); }}
                  />
                  <input
                    className="px-input"
                    type="text"
                    ...
                    value={lastName}
                    onChange={(e) => { setLastName(e.target.value); clearNotices(); }}
                  />
                  <input
                    className="px-input"
                    type="email"
                  ...
                  <div style={{ position: "relative" }}>
                    <input
                      ...
                      onChange={(e) => { setConfirmPassword(e.target.value); clearNotices(); }}
                      style={{ paddingRight: 46 }}
                    />
                    <button
                      type="button"
