...
const Ocotillo: React.FC<OcotilloProps> = ({
  onContinue,
  onBack,
  onClose,
...
>
  ...
  <iframe
    src="https://player.vimeo.com/video/829585981?autoplay=0&muted=0&playsinline=1"
    title="Ocotillo"
    loading="lazy"
