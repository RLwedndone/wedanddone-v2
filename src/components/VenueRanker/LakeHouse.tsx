...
const LakeHouse: React.FC<LakeHouseProps> = ({
  onContinue,
  onBack,
  onClose,
  ...
  const venueId = "lakehouse";
  const [showError, setShowError] = useState(false);
  const [showTooltip, setShowTooltip] = useState(false);

  // ✅ Guard selections so undefined never crashes radios
...
>
  <iframe
    src="https://player.vimeo.com/video/848914703?autoplay=0&muted=0&playsinline=1"
    title="Lake House"
    loading="lazy"
