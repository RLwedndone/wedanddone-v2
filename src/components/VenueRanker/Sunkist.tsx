...
const Sunkist: React.FC<SunkistProps> = ({
  onContinue,
  onBack,
  onClose,
...
>
  ...
  <iframe
    src="https://player.vimeo.com/video/829585100?autoplay=0&muted=0&playsinline=1"
    title="Sunkist"
    loading="lazy"
