...
const HaciendaDelSol: React.FC<HaciendaDelSolProps> = ({
  onContinue,
  onBack,
  onClose,
  goToExplore,
  ...
  // ✅ add these so we can show "x of y"
  screenList,
  currentIndex,
  ...
  const handleSelect = (value: number) => {
    ...
    // ✅ keep local guest fallback in sync too
    try {
  ...
  return (
    <div className="pixie-card wd-page-turn">
      ...
      {/* ✅ prevent weird mobile sideways scroll if SaveProgressMini is wide */}
      <div className="pixie-card__body" style={{ overflowX: "hidden" }}>
        ...
        >
          ...
          <div
            style={{
              textAlign: "center",
              marginTop: 16, // ✅ more space above
              marginBottom: 22, // ✅ more space below
            }}
          >
            <div
              style={{
          ...
          {/* ❌ removed old bottom-left SaveProgressMini */}
        </div>
      </div>
    </div>
  );
