...
const Soho63: React.FC<Soho63Props> = ({
  onContinue,
  onBack,
  onClose,
...
>
  ...
  <iframe
    src="https://player.vimeo.com/video/829956929?autoplay=0&muted=0&playsinline=1"
    title="Soho63"
    loading="lazy"
