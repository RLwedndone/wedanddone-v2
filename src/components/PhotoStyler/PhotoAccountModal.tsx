...
const PhotoAccountModal: React.FC<PhotoAccountModalProps> = ({ onSuccess, onClose }) => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      console.error("[PhotoAccountModal] signup failed:", err);
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      console.error("[PhotoAccountModal] login failed:", err);
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      console.error("[PhotoAccountModal] reset failed:", err);
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      console.error("[PhotoAccountModal] Google sign-in failed:", err);
        ...
        <div className="pixie-card__body">
          ...
          {step === "choice" && (
            <>
              <h2 className="px-title-lg" style={{ marginBottom: "0.5rem" }}>
                Ready to style your wedding photos? 📸
              </h2>
          ...
          {step === "signup" && (
            <>
              ...
              >
                📸 Quick note: all of our photographers and photo magic are based in Arizona.
                Wed&amp;Done is currently booking Arizona weddings only, but we&apos;ll be capturing love stories in more places soon!
              </p>
