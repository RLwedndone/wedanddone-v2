// src/components/NewYumBuild/CustomVenues/VicandVerrado/VicVerradoDessertMenu.tsx
...
interface VicVerradoDessertMenuProps {
...
const VicVerradoDessertMenu: React.FC<VicVerradoDessertMenuProps> = ({
  dessertType,
  flavorFilling,
  setFlavorFilling,
  onContinue,
  ...
  return (
    <>
      <h2 style={{ fontSize: "2.2rem", marginBottom: "1.5rem", textAlign: "center" }}>
        Build Your{" "}
    ...
    >
      ...
      {showModal === "cupcakes" && (
        <FlavorModal
          ...
          maxSelections={2}
          onChange={({ titles }) => {
            // ensure titles come from allowed list (defensive)
...
export default VicVerradoDessertMenu;