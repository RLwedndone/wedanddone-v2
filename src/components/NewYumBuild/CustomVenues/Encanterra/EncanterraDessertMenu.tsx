// src/components/NewYumBuild/CustomVenues/Encanterra/EncanterraDessertMenu.tsx
...
interface EncanterraDessertMenuProps {
...
const EncanterraDessertMenu: React.FC<EncanterraDessertMenuProps> = ({
  dessertType,
  flavorFilling,
  setFlavorFilling,
  onContinue,
  ...
  const handleContinue = () => {
    ...
    console.log("[ENCANTERRA][DessertMenu] continue with →", selections);
    ...
    <div className="pixie-card pixie-card--modal" style={{ maxWidth: 680 }}>
      ...
      {showModal === "cupcakes" && (
        <FlavorModal
          ...
          maxSelections={2}
          onChange={({ titles }) => {
            setCupcakes(titles); // match template behavior (no extra filtering)
...
export default EncanterraDessertMenu;