// src/components/NewYumBuild/CustomVenues/Encanterra/EncanterraDessertSelector.tsx
...
const EncanterraDessertSelector: React.FC<Props> = ({
  onSelectType,
  onBack,
...
export default EncanterraDessertSelector;