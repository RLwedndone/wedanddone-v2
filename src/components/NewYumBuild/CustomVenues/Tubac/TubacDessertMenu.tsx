...
interface TubacDessertMenuProps {
...
const TubacDessertMenu: React.FC<TubacDessertMenuProps> = ({
  dessertType,
  flavorFilling,
  setFlavorFilling,
  onContinue,
  ...
  // When dessertType changes, wipe transient picks (matches global flow)
  useEffect(() => {
    setTreatType("");
    setGoodies([]);
    setCupcakes([]);
  ...
  const handleContinue = () => {
    ...
    console.log("[TUBAC][DessertMenu] continue with →", selections);
...
export default TubacDessertMenu;