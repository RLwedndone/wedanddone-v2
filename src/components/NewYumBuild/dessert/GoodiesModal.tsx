...
// 🔧 FIX: wrap all BASE_URL paths in backticks
const GROUP_ICONS: Partial<Record<string, string>> = {
  "Brownies & Bars": `${import.meta.env.BASE_URL}assets/images/YumYum/goodies_icons/brownies_bars.png`,
  "Shortbread Squares": `${import.meta.env.BASE_URL}assets/images/YumYum/goodies_icons/shortbread.png`,
  "Cheesecake Bites": `${import.meta.env.BASE_URL}assets/images/YumYum/goodies_icons/cheesecake_bites.png`,
  "Homestyle Cookies": `${import.meta.env.BASE_URL}assets/images/YumYum/goodies_icons/cookies.png`,
  "Tarts": `${import.meta.env.BASE_URL}assets/images/YumYum/goodies_icons/tarts.png`,
  "Shooters": `${import.meta.env.BASE_URL}assets/images/YumYum/goodies_icons/shooters.png`,
  "Other Treats": `${import.meta.env.BASE_URL}assets/images/YumYum/goodies_icons/other_treats.png`,
};
...
const GoodiesModal: React.FC<GoodiesModalProps> = ({
  ...
  const grouped = useMemo(() => {
    ...
    // sort flavors inside each group
    for (const [, v] of map) {
      v.items.sort((a, b) => a.label.localeCompare(b.label));
    }

    // order groups by GROUP_ORDER, then any extras
    const ordered: Array<
      [
        string,
        {
    ...
    <div className="pixie-overlay" style={{ zIndex: 2000 }}>
      ...
      >
        ...
        <style>{`
          ...
          .goodies-scroll::-webkit-scrollbar {
            display: none;
          }
        `}</style>
        ...
        >
          ...
          >
            Choose any number of goodies! Prices are per dozen; minimum
            dozens apply per flavor.
          </p>
