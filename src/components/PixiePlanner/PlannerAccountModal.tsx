...
const PlannerAccountModal: React.FC<PlannerAccountModalProps> = ({ onSuccess, onClose }) => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      console.error("[PlannerAccountModal] signup failed:", err);
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      console.error("[PlannerAccountModal] login failed:", err);
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      console.error("[PlannerAccountModal] reset failed:", err);
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      console.error("[PlannerAccountModal] Google sign-in failed:", err);
        ...
        <div className="pixie-card__body">
          ...
          {step === "signup" && (
            <>
              ...
              >
                ✨ Quick heads-up: our planning pixies are currently focused on Arizona weddings.
                Wed&amp;Done is booking Arizona celebrations only for now — but we&apos;ll be waving our wands in more states soon!
              </p>
